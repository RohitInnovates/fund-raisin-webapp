            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4 mt-4 mt-lg-0">
                    <div class="icon-box">
                        ...
                        <div class="entry-content">
                            <p> We hold online confrences from time to time to make people aware,whose information we reach you through our news portal. </p>
                        </div>
                    </div>
                </div>
            </div><!-- .row -->
                ...
                <div class="col-12 col-lg-6 order-2 order-lg-1">
                    <div class="welcome-content">
                        ...
                        <div class="entry-content mt-5">
                            <p>Wellcome to our charitable foundation. We want everyone to benefit from potential to improve health and save lives.
                                We support to do help into life, health and wellbeing, and we’re taking on three health challenges in India :uneducativity, regular supply of drinking water in some areas and Malnutrition due to lack of appetite and health.
                                Our most important work is to provide nutritous food to take the people,to provide potable water and to work for the education of children.</p>
                        </div><!-- .entry-content -->
            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="upcoming-events">
                        ...
                        $stm = $db->query("select * from addnews");
                        $rows = $stm->fetchAll();
                        foreach ($rows as $row) {

                        ?>
                            <div>
                                <img src="news/<?= $row['pics'] ?>" class="img-thumbnail w-50" />
                                <div>
                                    <h3><?= $row['title'] ?></h3>
                                    <p><?= $row['descr'] ?></p>
                                </div>
                    ...
                    <div class="featured-cause">
                        ...
                        <div class="cause-wrap d-flex flex-wrap justify-content-between">
                            ...
                            <div class="cause-content-wrap">
                                ...
                                <div class="entry-content">
                                    <p class="m-0">Our fundraising ideas are a great place to start. Hold an event, sell your old stuff or get sponsored to do something silly - the money you raise will tranform children’s lives.</p>
                                </div><!-- .entry-content -->
                            ...
                            <div class="swiper-slide">
                                <div class="cause-wrap">
                                    ...
                                    <div class="cause-content-wrap">
                                        ...
                                        <div class="entry-content">
                                            <p class="m-0">We provide water, sanitation, and hygiene hardware (water filters, handwashing and drinking stations, toilet construction) and custom hygiene education to students, staff, and local communities. </p>
                                        </div><!-- .entry-content -->
                            ...
                            <div class="swiper-slide">
                                <div class="cause-wrap">
                                    ...
                                    <div class="cause-content-wrap">
                                        ...
                                        <div class="entry-content">
                                            <p class="m-0">We help India’s children start and stay in school. When children are forced into child labor, are abused or trafficked, we work to protect them and keep them free from violence.</p>
                            ...
                            <div class="swiper-slide">
                                <div class="cause-wrap">
                                    ...
                                    <div class="cause-content-wrap">
                                        ...
                                        <div class="entry-content">
                                            <p class="m-0">We provide water, sanitation, and hygiene hardware (water filters, handwashing and drinking stations, toilet construction) and custom hygiene education to students, staff, and local communities.
                                                Your generosity brings dignity, good health, opportunity, and joy to kids in india and others just like them!</p>
                                        </div><!-- .entry-content -->
