    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-10" style="min-height:550px;">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h1 style="text-align:center">Donate Management</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table table-responsiv">
                            ...
                            $db = (new Db())->dbConnection();
                                $cmd = "select * from donate";
                                $stm = $db->query($cmd);
                                if ($rows = $stm->fetchAll()) {
                                    $a = 0;
                                   foreach($rows as $row) {
                                        $a++;
                                        echo "<tr><td>$a</td><td>" . $row["name"] . "</td><td>" . $row["email"] . "</td><td>" . $row["mob"] . "</td><td>" . $row["amount"] . "</td><td>" . $row["pdonation"] . "</td><td>" . $row["address"] . "</td><td>" . $row["ddt"] . "</td><td><a href='../codes/deldon.php/?v=" . $row["email"] . "'><span class='fa fa-trash' style='color:red;font-size:15px'></span></a></td></tr>";
                                    }
                                } else {
