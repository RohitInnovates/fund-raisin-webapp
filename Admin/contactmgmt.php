                        ...
                        <table class="table table-responsiv">
                            ...
                            if ($rows = $stm->fetchAll()) {
                                ...
                                foreach ($rows as $row) {
                                    ...
                                    $a++;
                                    echo "<tr><td>$a</td><td>" . $row["name"] . "</td><td>" . $row["email"] . "</td><td>" . $row["msg"] . "</td><td>" . $row["cdt"] . "</td><td><a href='../codes/delcon.php/?v=" . $row["email"] . "'><span class='fa fa-trash' style='color:red;font-size:15px'></span></a></td></tr>";
                                }
                            } else {
