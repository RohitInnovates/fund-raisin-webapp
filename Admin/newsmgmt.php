                    ...
                    <div class="col-sm-12">
                        <table class="table table-responsiv">
                            ...
                            if ($rows = $stm->fetchAll()) {
                                ...
                                foreach ($rows as $row) {
                                    $a++;
                                    echo "<tr><td>$a</td><td>" . $row["title"] . "</td><td>" . $row["pics"] . "</td><td>" . $row["descr"] . "</td><td>" . $row["ndt"] . "</td><td><a href='../codes/delnews.php/?v=" . $row["title"] . "'><span class='fa fa-trash' style='color:red;font-size:15px'></span></a></td></tr>";
                                }
                            } else {
