...
<body class="single-page elements-page">
					 ...
					 <div class="col-12 col-md-6" style="margin-top:-10%">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="accordion-wrap type-accordion">
                                <h3 class="entry-title d-flex justify-content-between align-items-center active">About Volunteers<span class="arrow-r"></span></h3>

                                <div class="entry-content">
                                    <p>Volunteers in the India are 10 million strong. They hold up the foundation of civil society. No matter what kind of volunteer work they do, they are contributing in invaluable ways. They are heroes! They are your advocates, champions, ambassadors, and worker bees. They fill many roles in different capacities. Their diverse skill sets give your nonprofit access to a selection of expertise. 
                                        These include board members, committee leads, exhibit guides, ushers, admins, and more.</p>
                                </div>

                                <h3 class="entry-title d-flex justify-content-between align-items-center">Volunteers Work<span class="arrow-r"></span></h3>

                                <div class="entry-content">
                                    <p>YoungIndia Foundation volunteers collect excess food which is then packed and distributed in the evenings to people living on the streets and others in need.</p>
                                </div>

                                <h3 class="entry-title d-flex justify-content-between align-items-center">There are many ways you can serve your community and be a vital part of Feed the Children’s mission.
                                     Together, we can bring food, essentials – and hope to families that need our support.<span class="arrow-r"></span></h3>

                                <div class="entry-content">
                                    <p>The Young India Foundation is a not-for-profit organisation headquartered in ghaziabad, India. The Foundation strives to eliminate streat hunger by implementing the Mid-Day Meal Programme. It provides nutritious meals to children and pepole living  on streats. 
                                        YoungIndia also aims to counter malnutrition and support right to education of children hailing from socio-economically challenging backgrounds.</p>
                                </div>
                            </div>
                        </div>
  ...
  <footer class="site-footer">
    ...
    <script type='text/javascript' src='js/jquery.js'></script>ss
